...
<div class="section-grid">
  ...
  <a class="section-link-card" href="/tech/vuepress-content-organization">
    <span>2026-04-03</span>
    <strong>VuePress 个人站的内容组织方式</strong>
    <p>当目录和主题线条清楚以后，文章才会更容易被找到、维护和重组。</p>
  </a>
  <a class="section-link-card" href="/tech/component-naming-for-future-self">
    <span>2026-04-10</span>
    <strong>写给未来自己的组件命名法</strong>
    <p>命名暴露边界，也决定了半年后你还能不能快速理解自己写过的代码。</p>
  </a>
  <a class="section-link-card" href="/tech/building-boundaries-for-small-sites">
    <span>2026-04-18</span>
    <strong>小站点也需要构建边界</strong>
    <p>视觉、导航和内容层各自独立，改版时才不会一改全动。</p>
  </a>
  <a class="section-link-card" href="/tech/stable-markdown-writing-workflow">
